...
function finishQuiz() {
    ...
    if(points < 30){
        document.querySelector('.scoreText1').innerHTML = 'Tá sabendo porra nenhuma em meu cpx';
        document.querySelector('.scorePct').style.color = '#f00';
    }else if(points >=30 && points < 70){
        document.querySelector('.scoreText1').innerHTML = 'Da pra melhorar em...';
        document.querySelector('.scorePct').style.color = '#ff0';
    }else if(points > 70){
        document.querySelector('.scoreText1').innerHTML = 'parabains!!!';
